...
static string token_names[] = {
	"{}", "IDENT_T", "NUMLIT_T", "STRLIT_T", "IF_T", "COND_T", "DISPLAY_T",
	"NEWLINE_T", "LISTOP1_T", "LISTOP2_T", "AND_T", "OR_T", "NOT_T",
	"DEFINE_T", "LET_T", "NUMBERP_T", "LISTP_T", "ZEROP_T", "NULLP_T",
	"STRINGP_T", "MODULO_T", "ROUND_T", "ELSE_T", "PLUS_T", "MINUS_T",
	"DIV_T", "MULT_T", "EQUALTO_T", "GT_T", "LT_T", "GTE_T", "LTE_T",
	"LPAREN_T", "RPAREN_T", "LBRACK_T", "RBRACK_T", "SQUOTE_T", "ERROR_T",
	"EOF_T"
};
...
static int table [][23] = 
//	  a   c   d   r   b   0   .   (   )   [   ]   +   -   *   /   '   =   <   >   ?   _   "  other
       {{32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32, 32},  // 0 not used
	{ 8,  9,  8,  8,  8,  2,  3, 24, 24, 24, 24,  5,  6, 24, 24, 24, 24,  7,  7, 32, 32, 12, 24},  // 1 starting
	{22, 22, 22, 22, 22,  2,  4, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22},  // 2 number
	{31, 31, 31, 31, 31,  4, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31, 31},  // 3 period
	{22, 22, 22, 22, 22,  4, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22},  // 4 number after decimal
	{23, 23, 23, 23, 23,  2,  3, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23},  // 5 plus
	{23, 23, 23, 23, 23,  2,  3, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23},  // 6 minus
	{23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 23, 24, 23, 23, 23, 23, 23, 23},  // 7 less than
	{ 8,  8,  8,  8,  8,  8, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 24,  8, 21, 21},  // 8 letter other than c
	{11,  8, 11,  8,  8,  8, 21, 21, 21, 21, 21, 24, 21, 10, 21, 21, 21, 21, 21, 21,  8, 21, 21},  // 9 letter c
	{ 8,  8, 11, 13,  8,  8, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21,  8, 21, 21},  // 10 letter a after c
	{11,  8, 11, 13,  8,  8, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21, 21,  8, 21, 21},  // 11 letter d after c, ca, or cd...
	{12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 12, 25, 12},  // 12 character after "
	{ 8,  8, 11, 13,  8,  8, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20,  8, 20, 20}}; // 13 r seen - is it the end of a listop?
...
LexicalAnalyzer::LexicalAnalyzer (char * filename)
{
	...
	symbols.insert (pair<string,token_type> ("cons", LISTOP2_T));
	symbols.insert (pair<string,token_type> ("list", LISTOP1_T));
	symbols.insert (pair<string,token_type> ("append", LISTOP2_T));
	...
	symbols.insert (pair<string,token_type> ("let", LET_T));
	...
	symbols.insert (pair<string,token_type> ("[", LBRACK_T));
	symbols.insert (pair<string,token_type> ("]", RBRACK_T));
